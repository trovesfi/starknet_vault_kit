...
dotenv.config();
import { ApproveCallParams, ContractAddr, Deployer, FlashloanCallParams, getMainnetConfig, Global, HyperLSTStrategies, Pricer, PricerFromApi, UNIVERSAL_ADAPTERS, UNIVERSAL_MANAGE_IDS, UniversalLstMultiplierStrategy, UniversalStrategies, UniversalStrategy, VesuAdapter, VesuModifyPositionCallParams, Web3Number } from "@strkfarm/sdk";
...
async function main() {
    ...
    const strategy = UniversalStrategies.find(u => u.name.includes('STRK'))!;
